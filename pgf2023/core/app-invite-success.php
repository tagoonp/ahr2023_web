                ...
                <div class="col-12 pt-4">
                  <div class="card">
                    <div class="card-body text-center">
                      ...
                      <?php 
                      if($currentUser['reviewer_acception'] == 'Y'){
                        ?>
                        <p>Thank you so much for your acceptance to be an abstract reviewer for the 17th PGF. We will send the abstracts and other related form to you later.</p>
                        <p> Yours sincerely,<br>
                        17th PGF coordinator</p>
                        <?php
                      }else{
                        ?>
                        <p>Thank you so much for your reply. Hope we can work together in the future.</p>
                        <p>Yours sincerely,<br>17th PGF coordinator</p>
                        <?php
                      }
                      ?>
              ...
              <div class="d-block d-sm-none">
                <div class="row mt-4">
                  <div class="d-grid gap-2 col-lg-6 mx-auto">
                    ...
                    <button class="btn btn-danger btn-lg" type="button" onclick="window.location='<?php echo ROOT_DOMAIN . 'pgf2023/api/php/authen?stage=logout'; ?>'">Log out</button>
                  </div>
                </div>
              </div>
            </div>
