...
>
  <head>
    ...
    <title>PGF2023 : Submittion success</title>
                  ...
                  <div class="card mb-5">
                    <div class="card-body pt-5 text-center">
                        ...
                        <div class="form-group text-center pb-5">
                          <button class="btn btn-primary" onclick="window.location = 'submission_view?sid=<?php echo $sid; ?>'">View your abstract</button> <button class="btn btn-primary" onclick="window.location='./'">Back to home</button> 
                        </div>
