              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-8 col-md-10">
                  <div class="card mb-5">
                    <div class="card-header bg-dark">
                      <h5 class="text-white mb-0">List of staff</h5>
                    </div>
                          ...
                          if(($res) && ($res['status'])){
                            foreach ($res['data'] as $row) {
                              ...
                              <tr>
                                ...
                                <td>
                                  <label class="switch">
                                    <input type="checkbox" class="switch-input" <?php if($row['role_admin'] == 'Y'){ echo "checked"; } ?> />
                ...
                <div class="col-12 col-sm-4 col-md-2">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter user code ..">
