...
>
  <head>
    ...
    <title>PGF2023 : Submit new abstract</title>
  ...
  <body>
                  ...
                  <div class="card mb-5">
                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="row">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td style="vertical-align: top;">
                                        <div class="text-dark"><?php echo $currentUser['title']. " ". $currentUser['fname'] . " " . $currentUser['lname']; ?></div>
                            ...
                            <div class="form-group col-12 pt-3">
                              <label for="">Upload abstract file : <span class="text-danger">* accept only word file (.doc, .docx)</span>,<br>follow instruction <a href="https://postgraduateforum2023.com/submission.php" target="_blank">- here -</a></label>
    ...
    <script>
      ...
      var dropzone_5 = new Dropzone("#dpz-single-file", {
        url: api + 'pgf2023/api/php/upload_abstract.php?uid=' + $('#txtUid').val() + '&token=' + $('#txtToken').val() + '&sid=' + $("#txtSid").val(),
