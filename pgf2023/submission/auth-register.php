...
>
  ...
  <body>
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-sm-12 col-md-6">
                        ...
                        <select id="multiPaticipant" name="multiPaticipant" class="form-select multiPaticipant">
                          <option value="" selected>Select</option>
                          <option value="1">Presenters (Author)</option>
                          <option value="3">Speaker</option>
                          <option value="2" <?php if((isset($_GET['type'])) && ($_GET['type'] == 'listener')){ echo "selected"; } ?>>Listeners</option>
                        </select>
                        <div class="text-danger" style="font-size: 0.8em;">** Careful! : Only author can submit the abstract</div>
                      </div>

                      <div id="onsiteDiv" class="dn">
                        <div class="col-sm-12">
                          <h6>For on-site visit only : <span class="text-danger">*</span></h6>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="1" id="defaultCheck3_1" />
                            <label class="form-check-label" for="defaultCheck3_1"> Want to join half day trip? <a href="https://medipe2.psu.ac.th/phaii/pgf2023/file/trip.png" target="_blank">Trip information here >></a></label>
                          </div>

                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="1" id="defaultCheck3_2" />
                            <label class="form-check-label" for="defaultCheck3_2"> Want to join AHR2023 ? <a href="https://ahr2023.com/" target="_blank">Conference information here >></a></label>
                          </div>
                        </div>
                      </div>
    ...
    <script>
      ...
      $(function(){
        $("#multiVisit").change(function(){
          if($("#multiVisit").val() == '1'){
            $('#onsiteDiv').removeClass('dn')
          }else{
            $('#onsiteDiv').addClass('dn')
            $('#defaultCheck3_1').prop('checked', '')
            $('#defaultCheck3_2').prop('checked', '')
          }
        })
      })
    </script>
