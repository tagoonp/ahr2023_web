...
if( $_SERVER['HTTP_HOST'] != 'medipe2.psu.ac.th'){
  header('Location: https://medipe2.psu.ac.th/har/pgf2023/submission/');
}
          ...
          <div class="w-px-400 mx-auto">
            ...
            <div class="app-brand mb-5">
              <a href="index.html" class="app-brand-link gap-2">
                <span class="app-brand-text demo text-body fw-bolder" style="text-transform: none; color: #000;">PGF 2023 Login</span>
              </a>
            </div>
            <!-- /Logo -->
