...
$strSQL = "SELECT * FROM sx4_account WHERE uid = '$uid' AND active_status = 'Y' AND delete_status = 'N'";
...
>
  <head>
    ...
    <title>PGF 2023 : Create new password</title>
          ...
          <div class="w-px-400 mx-auto">
            ...
            <div class="app-brand mb-5">
              <a href="index.html" class="app-brand-link gap-2">
                <span class="app-brand-text demo text-body fw-bolder" style="text-transform: none; color: #000;">PGF 2023<br><small>Forget password</small></span>
              </a>
            </div>
            <!-- /Logo -->
            <!-- <h4 class="mb-2">Welcome to PGF2023 registraion and submission system</h4> -->
            <p class="mb-4">Please enter you e-mail address to get reset password link</p>

            <form id="" class="mb-3" onsubmit="authen.update_password(); return false;">
              ...
              <div class="mb-3 form-password-toggle">
                <div class="d-flex justify-content-between">
                  <label class="form-label" for="password">Confirm new password : <span class="text-danger">*</span></label>
                </div>
                <div class="input-group input-group-merge">
