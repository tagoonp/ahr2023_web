                      ...
                      <table class="table table-striped" id="table-1">
                        <thead>
                          <tr>
                            ...
                            <th style="width: 100px;">Acception</th>
                            <th></th>
                          </tr>
                        </thead>
                        <tbody>
                          ...
                          if(($res) && ($res['status'])){
                            foreach ($res['data'] as $row) {
                              ...
                              <tr>
                                ...
                                <td style="vertical-align: top;">
                                 <?php echo $row['invitation_send'] ;?>
                                </td>
                                <td style="vertical-align: top;">
                                  <label class="switch">
                                    <input type="checkbox" class="switch-input" <?php if($row['reviewer_acception'] == 'Y'){ echo "checked"; } ?> />
                                    <span class="switch-toggle-slider">
                                    </span>
                                  </label>
                                </td>
                                <td style="text-align: right;">
                                  <button class="btn btn-icon"><i class="bx bx-search"></i></button>  
                                  <button class="btn btn-icon" onclick="user.set_reviewer_invitation('<?php echo $row['uid']; ?>')"><i class="bx bx-envelope"></i></button>  
                                  <button class="btn btn-icon"><i class="bx bx-trash"></i></button>  
                                </td>
                              </tr>
                              <?php
                            }
