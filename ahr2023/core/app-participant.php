                          ...
                          if(($res) && ($res['status'])){
                            foreach ($res['data'] as $row) {
                              ...
                              <tr>
                                ...
                                <td>
                                  <label class="switch">
                                    <input type="checkbox" class="switch-input" <?php if($row['role_author'] == 'Y'){ echo "checked"; } ?> onclick="user.toggleStatus('<?php echo $row['uid'];?>', 'role_author')" />
                                ...
                                <td>
                                  <label class="switch">
                                    <input type="checkbox" class="switch-input" <?php if($row['presenter'] == 'Y'){ echo "checked"; } ?> onclick="user.toggleStatus('<?php echo $row['uid'];?>', 'presenter')" />
                                    <span class="switch-toggle-slider">
                                    </span>
                                  </label>   
                                </td>
                                <td>
                                  <label class="switch">
                                    <input type="checkbox" class="switch-input" <?php if($row['listener'] == 'Y'){ echo "checked"; } ?> onclick="user.toggleStatus('<?php echo $row['uid'];?>', 'listener')" />
                                    <span class="switch-toggle-slider">
                                    </span>
                                  </label>
                                </td>
                                <td>
                                  <label class="switch switch-success">
                                    <input type="checkbox" class="switch-input" <?php if($row['active_status'] == 'Y'){ echo "checked"; } ?> onclick="user.toggleStatus('<?php echo $row['uid'];?>', 'active_status')" />
                                    <span class="switch-toggle-slider">
                                    </span>
                                  </label>
                                </td>
