              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-8 col-md-10">
                    <div class="card">
                      <div class="card-body">
                        <div class="row">
                          <div class="col-12"><label for="" style="font-size: 0.8em;">Title : </label></div>
                          <div class="text-dark"><?php echo $resAbstract['abstract_title']; ?></div>
                        </div>

                        <div class="row mt-3">
                          <div class="col-12 col-sm-6">
                            <div class="row">
                              <div class="col-12"><label for="" style="font-size: 0.8em;">Category : </label></div>
                              <div class="text-dark"><?php echo $resAbstract['abstract_category']; ?></div>
                            </div>
                          </div>
                          <div class="col-12 col-sm-6">
                            <div class="row">
                              <div class="col-12"><label for="" style="font-size: 0.8em;">Presentation type : </label></div>
                              <div class="text-dark"><?php echo $resAbstract['abstract_present_type']; ?></div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="row">
                              <div class="col-12 pt-3"><label for="" style="font-size: 0.8em;">List of author : </label></div>
                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="row">
                              <div class="col-12 pt-3"><label for="" style="font-size: 0.8em;">Upload file : </label></div>
                              <div class="text-dark">
                                <button class="btn btn-icon btn-label-primary" onclick="window.open('<?php echo $resAbstract['abstract_recent_file']; ?>', target='_blank')"><i class="bx bx-download"></i></button> <?php echo $resAbstract['abstract_recent_file']; ?>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row mt-3">
                          <div class="col-12">
                            <div class="row">
                              <div class="col-12 pt-3"><label for="" style="font-size: 0.8em;">Reviewer : </label></div>
                              <div class="col-12">
                        ...
                        <div class="row mt-3">
                          <div class="col-12">
                            <div class="row">
                              <div class="col-12 pt-3"><label for="" style="font-size: 0.8em;">Result : </label></div>
                              <div class="col-12">
                                <table class="table table-bordered table-stripted">
                                  <thead>
                                    <tr class="bg-dark">
