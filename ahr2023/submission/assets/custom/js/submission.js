var submission = {
    save_draft_btn(){
        if($("#txtTitle").val() == ''){
            ...
            $url = api + 'ahr2023/api/php/submission?stage=save_draft';
    ...
    send(){
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                var jxr = $.post(api + 'ahr2023/api/php/submission?stage=confirm_send' , param, function(){ }, 'json')
                        .always(function(snap){ 
                                console.log(snap);
                                if(snap.status == 'Success'){
    ...
    delete_upload(){
        Swal.fire({
            ...
            if (result.value) {
                ...
                var jxr = $.post(api + 'ahr2023/api/php/submission?stage=delete_uploaded_file' , param, function(){ }, 'json')
                        .always(function(snap){ 
                                console.log(snap);
                                if(snap.status == 'Success'){
                                    preload.hide()
    ...
    toggle_response(co_to, co_id, co_fullname){
        if(co_to == 'N'){
            Swal.fire({
                title: 'Are you sure?',
                text: "Un-set " + co_fullname + " as responding author author?",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.value) {
                    ...
                    var jxr = $.post(api + 'ahr2023/api/php/submission?stage=update_co_response' , param, function(){ }, 'json')
                            .always(function(snap){ 
                                    console.log(snap);
                                    if(snap.status == 'Success'){
    ...
    update_co(){
        ...
        $url = api + 'ahr2023/api/php/submission?stage=update_co';
    ...
    save_co(){
        ...
        $url = api + 'ahr2023/api/php/submission?stage=save_co';
    ...
    delete_co(id, co_name){
        Swal.fire({
            ...
            if (result.value) {
                ...
                $url = api + 'ahr2023/api/php/submission?stage=delete_co';
