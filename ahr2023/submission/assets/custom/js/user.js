...
var user = {
    toggleStatus(uid, par){
      ...
      var jxr = $.post(api + 'ahr2023/api/php/user?stage=toggleStatus' , param, function(){ }, 'json')
    ...
    set_reviewer(){
        ...
        preload.show()
        var jxr = $.post(api + 'ahr2023/api/php/user?stage=set_reviewer' , param, function(){ }, 'json')
                   .always(function(snap){ 
                        console.log(snap);
    ...
    send_invitation(){
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                // console.log(param);
                // return ;
                var jxr = $.post(api + 'ahr2023/api/php/user?stage=send_invitation' , param, function(){ }, 'json')
                           .always(function(snap){ 
                                console.log(snap);
                                // return ;
                                if(snap.status == 'Success'){
    ...
    remove_participant(uid){
        Swal.fire({
            ...
            if (result.value) {
                ...
                preload.show()
                var jxr = $.post(api + 'ahr2023/api/php/user?stage=remove_participant' , param, function(){ }, 'json')
                           .always(function(snap){ 
                                console.log(snap);
                                if(snap.status == 'Success'){
                                    window.location.reload()
