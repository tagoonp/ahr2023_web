...
>
  <head>
    ...
    <title>AHR-iCon 2023 : Forget passsword</title>
          ...
          <div class="w-px-400 mx-auto">
            ...
            <div class="app-brand mb-5">
              <a href="index.html" class="app-brand-link gap-2">
                <span class="app-brand-text demo text-body fw-bolder" style="text-transform: none; color: #000;">AHR-iCon 2023<br><small>Forget password</small></span>
              </a>
            </div>
            <!-- /Logo -->
