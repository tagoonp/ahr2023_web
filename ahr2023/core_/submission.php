...
>
  <head>
    ...
    <title>AHR-iCon 2023 : Submit new abstract</title>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-sm-6 pt-3">
                              ...
                              <select name="txtCat" id="txtCat" class="form-control">
                                ...
                                <option value="Global Health" <?php if(($abstract) && ($abstract['abstract_category'] == 'Global Health')){ echo "selected"; } ?>>Global Health</option>
                                <option value="Precision medicine and clinical bioinformatics" <?php if(($abstract) && ($abstract['abstract_category'] == 'Precision medicine and clinical bioinformatics')){ echo "selected"; } ?>>Precision medicine and clinical bioinformatics</option>
                                <option value="Biomedical Sciences and Biomedical Engineering" <?php if(($abstract) && ($abstract['abstract_category'] == 'Biomedical Sciences and Biomedical Engineering')){ echo "selected"; } ?>>Biomedical Sciences and Biomedical Engineering</option>
                                <option value="Pharmaceutical, Clinical, Health, and Data Sciences" <?php if(($abstract) && ($abstract['abstract_category'] == 'Pharmaceutical, Clinical, Health, and Data Sciences')){ echo "selected"; } ?>>Pharmaceutical, Clinical, Health, and Data Sciences</option>
                                <option value="Medical and Health Technology and Innovation" <?php if(($abstract) && ($abstract['abstract_category'] == 'Medical and Health Technology and Innovation')){ echo "selected"; } ?>>Medical and Health Technology and Innovation</option>
                                <option value="Post-covid health inequity" <?php if(($abstract) && ($abstract['abstract_category'] == 'Post-covid health inequity')){ echo "selected"; } ?>>Post-covid health inequity</option>
                                <option value="Monitoring and Evaluation of Healthcare" <?php if(($abstract) && ($abstract['abstract_category'] == 'Monitoring and Evaluation of Healthcare')){ echo "selected"; } ?>>Monitoring and Evaluation of Healthcare</option>
                              </select>
                            </div>
                            ...
                            <div class="form-group col-12 col-sm-6 pt-3">
                              ...
                              <select name="txtType" id="txtType" class="form-control">
                                <option value="">-- Select --</option>
                                <option value="Abstract" <?php if(($abstract) && ($abstract['abstract_present_type'] == 'Abstract')){ echo "selected"; } ?>>Abstract for Oral presentation</option>
                                <option value="Fullpaper" <?php if(($abstract) && ($abstract['abstract_present_type'] == 'Fullpaper')){ echo "selected"; } ?>>Fullpaper for Oral presentation</option>
                              </select>
                            </div>

                            <div class="d-none d-sm-block">
                              <div class="form-group col-12 pt-3">
                                <label for="">List of author : </label>
                            ...
                            <div class="form-group col-12 pt-3">
                              <label for=""><span class="text-danger" id="advise_message">Download template <a href="https://ahr2023.com/submission.php" target="_blank">- here -</a>, then upload your submission file below.</span> : </label>
                            ...
                            <div class="form-group pt-4 text-center">
                                ...
                                <button type="button" class="btn btn-danger btn-lg" onclick="submission.send()">Submit</button>
                            </div>
                          </div>
