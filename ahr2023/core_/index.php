...
>
  <head>
    ...
    <title>AHR-iCon 2023 : By Wisnior Submission System</title>
                    ...
                    <div class="card-body">
                      ...
                      if(($resAbstract) && ($resAbstract['status'])){
                        ...
                        <div class="text-left pt-3 pb-4">
                          <button class="btn btn-primary" onclick="window.location='submission?sid=<?php echo $sid; ?>'"><i class="bx bx-plus"></i> Submit new abstract</button>
                        </div>
