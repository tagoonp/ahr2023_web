    ...
    case 'confirm_send':
        ...
        if($resCheck){
            ...
            if($resUser){
                ...
                $content .= '<p>You have submitted the abstract in to AHR-iCon 2023 entitled <strong>"'.$abstract_title.'"</strong> and the next process is review process. You can check the submission progress by visit our system at  <a href="' . ROOT_DOMAIN . 'ahr2023/submission/">' . ROOT_DOMAIN . 'ahr2023/submission/</a> </p>';
                $content .= '<p>Regards, AHR-iCon 2023 Auto mailer system</p>';
                sendEmail(MAIL_EMAIL, MAIL_PASSWORD, MAIL_EMAIL, 'AHR-iCon2023 Auto mailer system', $user_fullname, $resUser['email'], 'AHR-iCon2023 Absctrct submitted notification.', $content);
            }
            ...
            if(($resStaff) && ($resStaff['status'])){
                foreach($resStaff['data'] as $row){
                    ...
                    $content = '<p>Dear ' . $user_fullname . '</p>';
                    $content .= '<p>Someone submit the abstract to AHR-iCon 2023 entitled <strong>"'.$abstract_title.'"</strong>. Please check at  <a href="' . ROOT_DOMAIN . 'ahr2023/submission/">' . ROOT_DOMAIN . 'ahr2023/submission/</a> </p>';
                    $content .= '<p>Regards, AHR-iCon 2023 Auto mailer system</p>';
                    sendEmail(MAIL_EMAIL, MAIL_PASSWORD, MAIL_EMAIL, 'AHR-iCon2023 Auto mailer system', $user_fullname, $row['email'], 'AHR-iCon2023 Absctrct submitted notification.', $content);
                }
            }
